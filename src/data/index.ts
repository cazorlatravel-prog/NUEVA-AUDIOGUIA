...
export const trails: Trail[] = [
  ...
  {
    id: "trail-7",
    name: "Ruta de los Pinos Centenarios",
    slug: "pinos-centenarios",
    type: "senderismo",
    difficulty: "media",
    distance: 8,
    duration: 180,
    elevationGain: 300,
    description:
      "Sendero circular que discurre entre pinos laricios centenarios de porte majestuoso, algunos con más de 500 años de antigüedad. La ruta atraviesa uno de los bosques mejor conservados de la península ibérica con ejemplares de troncos retorcidos que superan los 2 metros de diámetro.",
    shortDescription: "Recorrido entre pinos laricios de más de 500 años en un bosque excepcional.",
    images: [
      "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=800&h=500&fit=crop",
      "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=800&h=500&fit=crop",
      "https://images.unsplash.com/photo-1472214103451-9374bd1c798e?w=800&h=500&fit=crop",
    ],
    startPoint: { lat: 37.885, lng: -2.880 },
    endPoint: { lat: 37.885, lng: -2.880 },
    waypoints: [],
    highlights: ["Pinos centenarios", "Bosque de pino laricio", "Miradores naturales"],
    warnings: ["Desnivel acumulado moderado", "Llevar calzado adecuado"],
    permit: false,
    season: ["primavera", "verano", "otoño"],
    tags: ["bosque", "pinos", "circular"],
    featured: true,
  },
  {
    id: "trail-8",
    name: "Sendero del Embalse de la Bolera",
    slug: "embalse-bolera",
    type: "senderismo",
    difficulty: "facil",
    distance: 6,
    ...
    elevationGain: 100,
    description:
      "Agradable paseo circular bordeando el embalse de la Bolera, con vistas a las aguas turquesas y la Sierra del Pozo. El sendero transcurre por caminos bien señalizados entre pinos y encinas. Ideal para disfrutar en familia con posibilidad de baño en verano.",
    shortDescription: "Paseo fácil bordeando el embalse de aguas turquesas con vistas a la Sierra del Pozo.",
    images: [
      "https://images.unsplash.com/photo-1501785888041-af3ef285b470?w=800&h=500&fit=crop",
      "https://images.unsplash.com/photo-1472214103451-9374bd1c798e?w=800&h=500&fit=crop",
    ],
    startPoint: { lat: 37.785, lng: -2.975 },
    endPoint: { lat: 37.785, lng: -2.975 },
    waypoints: [],
    highlights: ["Embalse de la Bolera", "Vistas Sierra del Pozo", "Zona de baño"],
    permit: false,
    season: ["primavera", "verano", "otoño"],
    tags: ["fácil", "familiar", "embalse"],
    featured: false,
  },
  {
    id: "trail-9",
    name: "Ruta en 4x4 Sierra del Pozo",
    slug: "4x4-sierra-pozo",
    type: "4x4",
    difficulty: "dificil",
    distance: 45,
    duration: 300,
    elevationGain: 800,
    description:
      "Ruta todoterreno que recorre los rincones más inaccesibles de la Sierra del Pozo, alcanzando cotas superiores a 2.000 metros. Pistas forestales con tramos técnicos que atraviesan paisajes de alta montaña mediterránea, cortijos abandonados y zonas de avistamiento de cabra montés.",
    shortDescription: "Aventura todoterreno por pistas de alta montaña con vistas a 2.000m de altitud.",
    images: [
      "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=500&fit=crop",
      "https://images.unsplash.com/photo-1472214103451-9374bd1c798e?w=800&h=500&fit=crop",
      "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=800&h=500&fit=crop",
    ],
    startPoint: { lat: 37.800, lng: -2.950 },
    endPoint: { lat: 37.820, lng: -2.910 },
    waypoints: [],
    highlights: ["Pico de la Sierra del Pozo", "Cortijos abandonados", "Cabra montés"],
    warnings: ["Solo vehículos 4x4 preparados", "No apta en invierno ni días de lluvia", "Llevar combustible de reserva"],
    permit: true,
    permitInfo: "Solicitar autorización en la Consejería de Medio Ambiente",
    season: ["primavera", "verano", "otoño"],
    tags: ["4x4", "montaña", "aventura"],
    featured: false,
  },
  {
    id: "trail-10",
    ...
    elevationGain: 50,
    description:
      "Paseo urbano y periurbano que sigue el recorrido del agua a través de Cazorla, desde las fuentes y canales históricos hasta la Bóveda del Río Cerezuelo. Descubre cómo el agua ha moldeado la historia y la arquitectura del pueblo a lo largo de los siglos.",
    shortDescription: "Recorrido por Cazorla siguiendo fuentes, canales históricos y la Bóveda del Cerezuelo.",
    images: [
      "https://images.unsplash.com/photo-1432405972618-c6b0cfba8b00?w=800&h=500&fit=crop",
      "https://images.unsplash.com/photo-1533154683836-84ea7a0bc310?w=800&h=500&fit=crop",
    ],
    startPoint: { lat: 37.910, lng: -3.002 },
    endPoint: { lat: 37.907, lng: -2.997 },
    waypoints: [],
    highlights: ["Fuente de las Cadenas", "Bóveda del Río Cerezuelo", "Lavaderos históricos"],
    permit: false,
    season: ["primavera", "verano", "otoño", "invierno"],
    tags: ["urbano", "agua", "historia"],
    featured: true,
  },
];
...
export const accommodations: Accommodation[] = [
  ...
  {
    id: "aloj-7",
    name: "Parador de Cazorla",
    slug: "parador-cazorla",
    type: "hotel",
    stars: 4,
    description:
      "Emblemático Parador Nacional situado en pleno corazón del Parque Natural, rodeado de bosques de pinos a orillas del río Guadalquivir. Edificio de arquitectura serrana con amplios salones, piscina exterior y restaurante con gastronomía de la sierra. Un refugio de lujo en plena naturaleza.",
    shortDescription: "Parador Nacional en pleno Parque Natural con piscina y restaurante de cocina serrana.",
    images: [
      "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&h=500&fit=crop",
      "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=800&h=500&fit=crop",
      "https://images.unsplash.com/photo-1472214103451-9374bd1c798e?w=800&h=500&fit=crop",
    ],
    address: "Sierra de Cazorla, s/n, 23470 Cazorla",
    coordinates: { lat: 37.9150, lng: -2.9600 },
    phone: "953 727 075",
    email: "cazorla@parador.es",
    website: "https://www.parador.es/es/paradores/parador-de-cazorla",
    priceRange: "100€ - 220€/noche",
    amenities: ["WiFi", "Piscina", "Restaurante", "Parking", "Jardín", "Terraza", "Aire acondicionado", "Accesibilidad"],
    bookingUrl: "https://www.parador.es/es/paradores/parador-de-cazorla",
    petFriendly: false,
    accessible: true,
    featured: true,
  },
  {
    id: "aloj-8",
    name: "Casa Rural Las Herrerías",
    slug: "casa-rural-herrerias",
    type: "casa-rural",
    description:
      "Acogedora casa rural de piedra junto al histórico Puente de las Herrerías. Cuatro dormitorios con decoración rústica, salón con chimenea de leña y jardín privado con barbacoa. Ubicación privilegiada para acceder a las mejores rutas del parque.",
    shortDescription: "Casa de piedra junto al Puente de las Herrerías con chimenea y jardín privado.",
    images: [
      "https://images.unsplash.com/photo-1510798831971-661eb04b3739?w=800&h=500&fit=crop",
      "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=800&h=500&fit=crop",
      "https://images.unsplash.com/photo-1472214103451-9374bd1c798e?w=800&h=500&fit=crop",
    ],
    address: "Camino del Puente de las Herrerías, s/n, 23470 Cazorla",
    coordinates: { lat: 37.8920, lng: -2.9575 },
    phone: "670 234 567",
    email: "info@casaherrerias.es",
    priceRange: "130€ - 200€/noche (casa completa)",
    amenities: ["WiFi", "Chimenea", "Barbacoa", "Cocina equipada", "Jardín", "Parking", "Ropa de cama"],
    petFriendly: true,
    accessible: false,
    featured: false,
  },
  {
    ...
    slug: "hotel-guadalquivir",
    type: "hotel",
    stars: 3,
    description:
      "Hotel céntrico de 3 estrellas en el casco urbano de Cazorla con habitaciones cómodas y luminosas. Desayuno buffet con productos locales, cafetería y salón social. Base perfecta para explorar tanto el pueblo como el Parque Natural.",
    shortDescription: "Hotel céntrico de 3★ con desayuno buffet de productos locales.",
    images: [
      "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&h=500&fit=crop",
      "https://images.unsplash.com/photo-1510798831971-661eb04b3739?w=800&h=500&fit=crop",
    ],
    address: "C/ Nueva, 6, 23470 Cazorla",
    coordinates: { lat: 37.9092, lng: -2.9990 },
    phone: "953 720 268",
    email: "reservas@hotelguadalquivir.com",
    website: "https://www.hotelguadalquivir.com",
    priceRange: "55€ - 95€/noche",
    amenities: ["WiFi", "Desayuno buffet", "Cafetería", "Aire acondicionado", "TV", "Calefacción"],
    petFriendly: false,
    accessible: true,
    featured: false,
  },
  {
    id: "aloj-10",
    name: "Albergue Rural Parque Natural",
    slug: "albergue-rural-parque-natural",
    type: "hostal",
    description:
      "Albergue juvenil y rural en un entorno natural privilegiado, ideal para grupos, familias y viajeros con presupuesto ajustado. Habitaciones compartidas e individuales, cocina de uso común y amplia zona ajardinada. Organiza actividades de educación ambiental.",
    shortDescription: "Albergue económico en plena naturaleza con actividades ambientales.",
    images: [
      "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=800&h=500&fit=crop",
      "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=800&h=500&fit=crop",
    ],
    address: "Ctra. del Tranco, km 28, 23478 Coto Ríos",
    coordinates: { lat: 37.9580, lng: -2.8600 },
    phone: "953 713 120",
    email: "info@alberguecazorla.com",
    priceRange: "18€ - 35€/noche por persona",
    amenities: ["Cocina compartida", "Jardín", "Sala común", "Parking", "Actividades", "Lavandería"],
    petFriendly: false,
    accessible: false,
    featured: false,
  },
